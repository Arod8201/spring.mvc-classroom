...
public class User {
	...
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GTM+8") // 返回的日期格式
	...
	public String toString() {
		return "User [name= " + name + ", age= " + age + ", birth= " + birth + ", education= " + education + ", sex= "
				+ sex + ", interest= " + Arrays.toString(interest) + ", resume= " + resume + "]";
	}
